    ...
    <div className='mt-5'>
      <div className='bg-white w-full max-w-sm  rounded overflow-hidden p-4 mx-auto'>
        ...
        <form className='grid gap-4 mt-4' onSubmit={handleSubmit}>
            ...
            <label htmlFor='profile_pic'>
              ...
              <div className='h-14 bg-slate-200 flex justify-center items-center border rounded hover:border-primary cursor-pointer'>
                <p className='text-sm max-w-[300px] text-ellipis line-clamp-1'>{
                  ...
                  uploadPhoto?.name &&(
                    <button className='text-lg ml-2 mt-1 hover:text-red-600' onClick={handleClearUploadPhoto}>
          ...
          <button className='bg-primary text-lg px-4 py-1 hover:bg-secondary rounded mt-3 font-bold text-white'>
            Register
          </button>
